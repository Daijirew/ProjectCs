                     ...
                     showDialog(
                       ...
                       builder: (BuildContext context) {
                         return AlertDialog(
                           ...
                           content: Text('Are you sure you want to delete this cat? This action cannot be undone.'),
                           actions: [
                             TextButton(
                               child: Text('Cancel'),
                               ...
                               onPressed: () async {
                                 ...
                                 try {
                                   ...
                                   ScaffoldMessenger.of(context).showSnackBar(
                                     SnackBar(content: Text('Successfully deleted ${cat.name}')),
                                   );
                                 } catch (e) {
                                   ScaffoldMessenger.of(context).showSnackBar(
                                     SnackBar(content: Text('Error deleting cat: $e')),
                                   );
                                 }
                               },
                             ),
